// use crate::simpleserial::{ReceivedPacket, SSPacket, UnstuffedBuffer, MAX_SS_LEN, PKT_SIZE};
...
//         }
//     }
//     fn new(buffer: [u8; PKT_SIZE]) -> Self {
//         CTPacket {
//             cmd: buffer[0],
//             sub_cmd: buffer[1],
//             dlen: buffer[2],
//             data: sized_slice(buffer, 3, usize::from(buffer[2]) + 3, 0),
//         }
//     }
// }
